 ...
 *   time    ： 2021/4/6
 */
class OrderComfirmCartAdapter(val itemList:List<OrderComfirmCart>) :
    RecyclerView.Adapter<OrderComfirmCartAdapter.ViewHolder>(){
    ...
    inner class ViewHolder(view: View) : RecyclerView.ViewHolder(view){
        ...
        val itemNumber:TextView = view.findViewById(R.id.order_number)
    }
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.itemNumber.text = "x" + item.itemNumber.toString()
